...
7. Update the title of the app to reflect the current skinning mode and Inverse Kinematic mode
8. Provide a detailed report and comparison on Linear Blending Skinning vs Dual Quaternion Skinning vs Spherical Blending, check file HW3Report
9. Provide a detailed report and comparison on Tikhonov Regularization IK vs Pseudo Inverse IK vs Jacobian Transpose IK, check file HW3Report
